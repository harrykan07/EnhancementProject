...
import com.cts.training.collateralwebportal.model.ApplyLoan;
...
public class CustomerLoanController {
    ...
    public String applyLoanGet(@ModelAttribute("loanApplication")ApplyLoan loanApplication,ModelMap model,HttpServletRequest request) {
    ...
    public String applyLoanPost(@Valid @ModelAttribute("loanApplication")ApplyLoan loanApplication,ModelMap model,BindingResult result) {
    	if(result.hasErrors()) {
    		return "applyLoan";
    	}
...
//    	int custId=authClient.getCustId(token);
    ...
    public String viewLoanCust(ModelMap model,HttpServletRequest request) {
    	String token=(String)request.getSession().getAttribute("token");
    	int custId=authClient.getCustId(token);
    	ArrayList<ApplyLoan> list= loanClient.viewCustLoan(custId);
